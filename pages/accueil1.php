...
<html lang="en" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>WS example · Bootstrap v5.3</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          <h4>About</h4>
          <p class="text-body-secondary">bienvenue chez DussollierShop le reference des magasins de ventes de chaussures au canada </p>
        </div>
  ...
  <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
    <span class="visually-hidden">New alerts</span>
        ...
        <li><a href="./gestionProduit.php"> <button type="button" class="btn btn-info">gestion produit</button></a></li><?php } else{
            ...
            <li><a href="../pages/login.php" class="text-white"><button type="button" class="btn btn-danger">Deconnexion</button></a></li>
            <!-- <li>contact</li> -->
          </ul>
        </div>
      </div>
