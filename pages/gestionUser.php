...
<header>
    ...
    <a href="./deleteUser.php"><button type="submit" class="btn btn-primary">Cliquer ici pour supprimer un utilisateur</button></a>
    <a href="../pages/updateProduct.php"><button type="submit" class="btn btn-primary">Cliquer ici pour modifier un produit</button></a> -->
        <!-- <a href="">home</a>
        <a href="#">About</a>
        <a href="#">Services</a>
        <a href="#">contact</a>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./deleteUser"><button type="submit" class="btn btn-primary">cliquez pour supprimer un utilisateur</button></a>
        </li>
